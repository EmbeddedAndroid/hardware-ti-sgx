...
#	$RCSfile: install.sh.m4 $ $Revision: 1.138 $
#	$RCSfile: install.sh.m4 $ $Revision: 1.4 $
#
...
if [ -z "$NO_BCDEVICE" ]; then
	...
	#
	install_file libGLESv1_CM_POWERVR_SGX540_120.so /system/lib/egl/libGLESv1_CM_POWERVR_SGX540_120.so.1.1.17.4352 "shared library" 0644 0:0
	install_link libGLESv1_CM_POWERVR_SGX540_120.so.1.1.17.4352 /system/lib/egl/libGLESv1_CM_POWERVR_SGX540_120.so
	...
	install_file libGLESv2_POWERVR_SGX540_120.so /system/lib/egl/libGLESv2_POWERVR_SGX540_120.so.1.1.17.4352 "shared library" 0644 0:0
	install_link libGLESv2_POWERVR_SGX540_120.so.1.1.17.4352 /system/lib/egl/libGLESv2_POWERVR_SGX540_120.so
	...
	install_file libEGL_POWERVR_SGX540_120.so /system/lib/egl/libEGL_POWERVR_SGX540_120.so.1.1.17.4352 "shared library" 0644 0:0
	install_link libEGL_POWERVR_SGX540_120.so.1.1.17.4352 /system/lib/egl/libEGL_POWERVR_SGX540_120.so
	...
	install_file gralloc.omap4.so /system/lib/hw/gralloc.omap4.so.1.1.17.4352 "shared library" 0644 0:0
	install_link gralloc.omap4.so.1.1.17.4352 /system/lib/hw/gralloc.omap4430.so
	...
	VENDOR_LIB_NAME=`echo libEGL_POWERVR_SGX540_120.so | sed 's,libEGL_\|\.so,,g'`
